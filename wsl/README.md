# config-files — WSL2 (Ubuntu 20.04)

Configuration for the **WSL2 / Ubuntu 20.04** setup. For the native Ubuntu 26.04 machine see
[`../linux/`](../linux/); the [root README](../README.md) explains how the two differ.
